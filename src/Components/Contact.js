...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      copyFormData.append('to', 'allsmart.org@gmail.com');
      copyFormData.append('subject', subject);
      copyFormData.append('text', formattedMessage);

      await axios.post('/.netlify/functions/sendEmail', copyFormData, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
